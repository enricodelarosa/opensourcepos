...
$routes->get('api/cash/summary', 'Api\Cash::getSummary');
$routes->options('api/cash/summary', 'Api\Cash::getSummary');
...
$routes->add('reports/specific_loans', 'Reports::specific_loans_input');
