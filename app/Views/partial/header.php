...
<head>
    ...
    <?php if (ENVIRONMENT == 'development' || get_cookie('debug') == 'true' || $request->getGet('debug') == 'true') : ?>
        ...
        <link rel="stylesheet" href="resources/css/ospos-30b4e13787.css">
        ...
        <script src="resources/js/manage_tables-87e16dd22b.js"></script>
        <script src="resources/js/nominatim-89be77a11a.autocomplete.js"></script>
        <!-- endinject -->
    <?php else : ?>
        <!--inject:prod:css -->
        <link rel="stylesheet" href="resources/opensourcepos-04e06158b7.min.css">
        <!-- endinject -->
        ...
        <script src="resources/opensourcepos-360385b20d.min.js"></script>
        <!-- endinject -->
    <?php endif; ?>
