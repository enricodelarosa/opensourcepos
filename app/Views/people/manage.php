...
<?php $new_dialog_class = $controller_name === 'suppliers' ? 'modal-dlg modal-dlg-wide' : 'modal-dlg'; ?>
...
<div id="title_bar" class="btn-toolbar">
    ...
    <?php } ?>
    <button class="btn btn-info btn-sm pull-right <?= esc($new_dialog_class) ?>" data-btn-submit="<?= lang('Common.submit') ?>" data-href="<?= "{$controller_name}/view" ?>" title="<?= lang(ucfirst($controller_name) . '.new') ?>">
