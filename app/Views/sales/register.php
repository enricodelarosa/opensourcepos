    ...
    <div class="panel-body">
        <?= form_open("{$controller_name}/selectCustomer", ['id' => 'select_customer_form', 'class' => 'form-horizontal']) ?>
            <?php if (isset($customer)) { ?>
                <table class="sales_table_100">
                    ...
                    <?php } ?>
                    <?php if (isset($selected_luna) && $selected_luna) { ?>
                        <tr>
                            <th style="width: 55%;"><?= lang('Sales.luna_loan_balance') ?></th>
                            <th style="width: 45%; text-align: right; color: #d9534f;"><?= to_currency($customer_luna_loan_balance) ?></th>
                        </tr>
                    <?php } ?>
        ...
        $luna_options = ['' => '-- ' . lang(! empty($sale_luna_required) ? 'Sales.select_luna' : 'Sales.no_luna') . ' --'];
                    ...
                    foreach ($lunas as $luna_row) {
                        ...
                        if (! empty($luna_row['landowner_name'])) {
                            $label .= ' - ' . $luna_row['landowner_name'];
                        }
